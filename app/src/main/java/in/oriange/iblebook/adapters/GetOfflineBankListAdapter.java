...
public class GetOfflineBankListAdapter extends RecyclerView.Adapter<GetOfflineBankListAdapter.MyViewHolder> {
    ...
    public GetOfflineBankListAdapter(Context context, List<GetBankListPojo> resultArrayList, String STATUS) {
...
//                                        }
    ...
    private void setSelectionFilter(final int position) {
        ...
        alertDialogBuilder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialod, int id) {
                ...
                String finalDataShare = name + " shared bank details with you " + "\n\n" + sb.toString() + "\n" + "via Iblebook \n" + "Click Here - " + ApplicationConstants.IBLEBOOK_PLAYSTORELINK;
    ...
    public class MoveAddressDetails extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String res = "[]";
            JsonObject obj = new JsonObject();
            obj.addProperty("type", "bank");
            obj.addProperty("record_id", resultArrayList.get(Integer.parseInt(params[0])).getBank_id());
