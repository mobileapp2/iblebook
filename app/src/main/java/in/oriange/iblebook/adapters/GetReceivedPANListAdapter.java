...
public class GetReceivedPANListAdapter extends RecyclerView.Adapter<GetReceivedPANListAdapter.MyViewHolder> {
    private static List<GetTaxListPojo> resultArrayList;
    private final UserSessionManager session;
    private Context context;
    private String name, STATUS;

    public GetReceivedPANListAdapter(Context context, List<GetTaxListPojo> resultArrayList, String STATUS) {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            ...
                            case R.id.menu_move:
                                ...
                                builder1.setPositiveButton("My PAN", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
