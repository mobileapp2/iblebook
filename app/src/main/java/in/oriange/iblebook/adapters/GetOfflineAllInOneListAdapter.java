...
public class GetOfflineAllInOneListAdapter extends RecyclerView.Adapter<GetOfflineAllInOneListAdapter.MyViewHolder> {
    ...
    public GetOfflineAllInOneListAdapter(Context context, List<AllInOneModel> resultArrayList, String STATUS) {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            ...
                            case R.id.menu_move:
                                ...
                                builder1.setNegativeButton("Received", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        new MoveAllInOneDetails().execute(String.valueOf(position), "received");
                                    }
                                });
