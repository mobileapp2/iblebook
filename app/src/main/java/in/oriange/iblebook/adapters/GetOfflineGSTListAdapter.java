...
public class GetOfflineGSTListAdapter extends RecyclerView.Adapter<GetOfflineGSTListAdapter.MyViewHolder> {
    ...
    public GetOfflineGSTListAdapter(Context context, List<GetTaxListPojo> resultArrayList, String STATUS) {
...
//                                        }
                            ...
                            case R.id.menu_move:
                                ...
                                builder1.setMessage("Where to icon_swap this GST details?");
                                ...
                                builder1.setNegativeButton("My GST", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        builder.setIcon(R.drawable.ic_success_24dp);
                        builder.setTitle("Success");
                        builder.setMessage("Bank details moved successfully.");
                        builder.setCancelable(false);
                        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
