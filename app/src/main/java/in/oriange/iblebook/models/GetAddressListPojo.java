...
public class GetAddressListPojo {
    ...
    {
        return "ClassPojo [created_by = "+created_by+", status = "+status+", alias = "+alias+", website = "+website+", address_line_one = "+address_line_one+", state = "+state+", address_line_two = "+address_line_two+", photo = "+photo+", type_id = "+type_id+", country = "+country+", pincode = "+pincode+", updated_at = "+updated_at+", visiting_card = "+visiting_card+", map_location_logitude = "+map_location_logitude+", address_id = "+address_id+", map_location_lattitude = "+map_location_lattitude+", name = "+name+", created_at = "+created_at+", updated_by = "+updated_by+", district = "+district+", email_id = "+email_id+"]";
    }
}
