...
public class Add_Bank_Activity extends Activity {
    ...
    private void init() {
        context = Add_Bank_Activity.this;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(Add_Bank_Activity.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(Add_Bank_Activity.this);
            }
...
//                    Utilities.showSnackBar(ll_parent, message);
    ...
    public class UploadBankDetails extends AsyncTask<String, Void, String> {
    ...
    protected void setupToolbar() {
        ...
        mToolbar.setTitle("Add Bank Details");
