...
//        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(Add_PAN_Activity.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(Add_PAN_Activity.this);
            }
    ...
    protected void setupToolbar() {
        ...
        mToolbar.setTitle("Add PAN Details");
...
//                    Utilities.showSnackBar(ll_parent, message);
    ...
    public class UploadPANDetails extends AsyncTask<String, Void, String> {
