...
public class Add_GST_Activity extends Activity {
    ...
    protected void onPause() {
        super.onPause();
        hideSoftKeyboard(Add_GST_Activity.this);
    }

    private void init() {
        context = Add_GST_Activity.this;
...
//        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(Add_GST_Activity.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(Add_GST_Activity.this);
            }
    ...
    protected void setupToolbar() {
        ...
        mToolbar.setTitle("Add GST Details");
            ...
            try {
                ...
                if (result != null && result.length() > 0 && !result.equalsIgnoreCase("[]")) {
                    ...
                    if (type.equalsIgnoreCase("Success")) {
                        ...
                        new UploadGSTDetails().execute(STATUS);
                    } else {
...
//                    Utilities.showSnackBar(ll_parent, message);
    ...
    public class UploadGSTDetails extends AsyncTask<String, Void, String> {
