...
import in.oriange.iblebook.adapters.GetMyAllInOneListAdapter;
...
public class My_AllInOne_Fragment extends Fragment {
    ...
    public static void setDefault() {
        ...
        if (allInOneList.size() != 0) {
            for (int i = 0; i < allInOneList.size(); i++) {
                if (allInOneList.get(i).getStatus().equals("online")) {
            ...
            if (sortedAllInOneList.size() != 0) {
                ...
                rv_allinonelist.setAdapter(new GetMyAllInOneListAdapter(context, sortedAllInOneList, "ONLINE"));
            } else {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_my_allinone, container, false);
        context = getActivity();
        init(rootView);
//        setDefault();
        getSessionData();
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (!query.equals("")) {
                    ...
                    rv_allinonelist.setAdapter(new GetMyAllInOneListAdapter(context, addressSearchedList, "ONLINE"));
                } else {
                    rv_allinonelist.setAdapter(new GetMyAllInOneListAdapter(context, sortedAllInOneList, "ONLINE"));
                }
                return true;
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                if (!result.equals("")) {
                    ...
                    rv_allinonelist.setAdapter(new GetMyAllInOneListAdapter(context, allInOneList, "ONLINE"));
                    if (type.equalsIgnoreCase("success")) {
                        for (int i = 0; i < pojoDetails.getResult().size(); i++) {
                            if (pojoDetails.getResult().get(i).getStatus().equalsIgnoreCase("online")) {
